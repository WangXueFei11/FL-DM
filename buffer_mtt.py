...
def main(args):
    ...
    for it in range(0, args.Iteration):
        ...
        teacher_net = get_network(args.model, channel, num_classes, im_size, depth=args.depth, width=args.width, norm=args.norm_train, args=args).to(args.device) # get a random model
        teacher_net.train()
